...
print("\tI'will work on a better and more functional version of this project in which you can save the links, titles, summaries in an organized and colorful cli version soon.")
print("\n\n\t\t\t\t\t\tEmreYbs wishes you a lovely day... 'Bye for now...' \n\n")
